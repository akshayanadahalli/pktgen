...
[ -z "$UDP_SP_MIN" ] && UDP_SP_MIN="5326"
[ -z "$UDP_SP_MAX" ] && UDP_SP_MAX="5326"
[ -z "$UDP_DP_MIN" ] && UDP_DP_MIN="991"
[ -z "$UDP_DP_MAX" ] && UDP_DP_MAX="991"
...
for ((thread = $F_THREAD; thread <= $L_THREAD; thread++)); do
    ...
    pg_set $dev "vlan_id 1" 
    pg_set $dev "dst$IP6 $DEST_IP"
#    pg_set $dev "src 2.0.0.1"

    # Source
    pg_set $dev "src_min 2.0.0.3"
    pg_set $dev "src_max 2.0.0.3"
